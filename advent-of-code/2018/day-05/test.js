...
describe('Part 1', () => {
  it(`should return ${TESTS.part1.test1.result} for input ${TESTS.part1.test1.input}`, () => {
    partOne(TESTS.part1.test1.input).should.equal(TESTS.part1.test1.result);
  });
  it(`should return ${TESTS.part1.test2.result} for input ${TESTS.part1.test2.input}`, () => {
    partOne(TESTS.part1.test2.input).should.equal(TESTS.part1.test2.result);
  });
  it(`should return ${TESTS.part1.test3.result} for input ${TESTS.part1.test3.input}`, () => {
    partOne(TESTS.part1.test3.input).should.equal(TESTS.part1.test3.result);
  });
  it(`should return ${TESTS.part1.test4.result} for input ${TESTS.part1.test4.input}`, () => {
    partOne(TESTS.part1.test4.input).should.equal(TESTS.part1.test4.result);
  });
  it(`should return ${TESTS.part1.test5.result} for input ${TESTS.part1.test5.input}`, () => {
    partOne(TESTS.part1.test5.input).should.equal(TESTS.part1.test5.result);
  });
});

describe('Part 2', () => {
  it(`should return ${TESTS.part2.test1.result} for input ${TESTS.part2.test1.input}`, () => {
